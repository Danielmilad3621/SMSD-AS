...
Vercel builds the app using the static build preset and serves the `dist/` output. Client-side routing is handled via a catch-all route to `index.html` (see `vercel.json`).
